...
namespace KnockoutjsAsp.Controllers.API
{
    [Route("api/[controller]")]
    [ApiController]
    public class StudentModelsController : ControllerBase
    {
        private readonly KnockoutjsAspContext _context;

        public StudentModelsController(KnockoutjsAspContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<StudentModel>> PostStudentModel(StudentModel studentModel)
        {
            if (_context.StudentModel == null)
            {
                return Problem("Entity set 'KnockoutjsAspContext.StudentModel'  is null.");
            }
